...
function Home() {
  return (
    <section id="home" className="w-9/12">
      <div className="flex h-screen flex-col items-center justify-evenly text-justify xl:flex-row-reverse xl:justify-between">
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-light max-w-xl text-lg md:text-2xl lg:max-w-2xl">
